...
conn ikev2-cp
  ...
  rekey=no
  pfs=no
  ike=chacha20poly1305-sha512-curve25519-prfsha512,aes_gcm_c_256-hmac_sha2_256-ecp_256,aes256-sha2,aes128-sha2,aes256-sha1,aes128-sha1
  phase2alg=chacha20poly1305-sha512,aes_gcm-null,aes128-sha1,aes256-sha1,aes128-sha2,aes256-sha2
  ikelifetime=24h
  salifetime=24h
  encapsulation=yes
